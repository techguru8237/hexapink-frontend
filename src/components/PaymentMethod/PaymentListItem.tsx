  ...
  return (
    <div className="w-full flex items-center gap-2 text-light-dark">
      ...
      >
        ...
        <div className="w-full p-3 flex items-center justify-between gap-2 border-l border-dashed border-light-gray3">
        ...
        <div className="w-full p-3 flex items-center gap-2 border-l border-dashed border-light-gray3">
          <button className="h-8 bg-[#F0F0FA] border border-light-gray3 rounded-l-lg flex items-center justify-center rounded-lg">
            Suspended
          </button>
