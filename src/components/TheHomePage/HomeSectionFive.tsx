...
export default function HomeSectionFive() {
  return (
    <div className="flex justify-center items-center w-full lg:h-[736px] h-[600px] relative">
      ...
      <div className="absolute w-full sm:px-12 md:px-20 lg:px-28 xl:px-36 2xl:px-48 flex justify-center items-center z-30 flex-col gap-8">
        <img
          src={CoFounderImage}
          alt=""
          className="lg:w-[10%] md:w-[25%] w-[40%]"
        />
        <div className="xl:w-[60%] w-full px-8 flex flex-col justify-center items-center">
